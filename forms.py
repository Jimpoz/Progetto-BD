...
class Create_Test(FlaskForm):
    ...
    sufficienza = StringField('Sufficienza', validators=[InputRequired(), Length(max=50)], render_kw={"placeholder": "Sufficienza"})
    peso = StringField('Peso', validators=[InputRequired(), Length(max=50)], render_kw={"placeholder": "Peso"})
