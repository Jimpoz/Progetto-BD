...
Revision ID: d3a01f25ce7c
Revises: b9c16d50351f
Create Date: 2023-07-22 22:37:41.807531
...
revision = 'd3a01f25ce7c'
down_revision = 'b9c16d50351f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('docente', 'password', type_=sa.String(200))
...
def downgrade():
    ...
    sa.Column('idd', sa.CHAR(length=200), autoincrement=False, nullable=False),
