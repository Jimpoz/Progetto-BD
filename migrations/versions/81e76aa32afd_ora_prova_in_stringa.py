"""ora prova in stringa

Revision ID: 81e76aa32afd
Revises: a171a943b3ee
Create Date: 2023-06-09 13:10:57.130066
...
revision = '81e76aa32afd'
down_revision = 'a171a943b3ee'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('prova', schema=None) as batch_op:
        batch_op.alter_column('ora_prova',
